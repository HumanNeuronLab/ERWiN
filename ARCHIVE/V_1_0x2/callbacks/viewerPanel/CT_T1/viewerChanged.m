    ...
    if isequal(currTab,'CT') || isequal(currTab,'T1')
        ...
        if isequal(currTab,'CT') && ~(isequal(evt.NewValue.Title,'[select CT NIfTI file]'))
            ...
            if ~(isequal(widget.tab_T1.Title,'[select Anatomical NIfTI file (optional)]'))
                ...
                evt.NewValue.Children(coronalIdx).Children(2).Children(1).Position = ...
                    widget.tab_T1.Children(coronalIdx).Children(2).Children(1).Position;
                evt.NewValue.Children(coronalIdx).Children(2).Children(2).Tag = ...
                    widget.tab_T1.Children(coronalIdx).Children(2).Children(2).Tag;
                evt.NewValue.Children(coronalIdx).Children(2).Children(2).CData = widget.glassbrain.UserData.CTvol(:,:,str2double(evt.NewValue.Children(coronalIdx).Children(2).Children(2).Tag));
                ...
                evt.NewValue.Children(sagittalIdx).Children(2).Children(1).Position = ...
                widget.tab_T1.Children(sagittalIdx).Children(2).Children(1).Position;
                evt.NewValue.Children(sagittalIdx).Children(2).Children(2).Tag = ...
                    widget.tab_T1.Children(sagittalIdx).Children(2).Children(2).Tag;
                evt.NewValue.Children(sagittalIdx).Children(2).Children(2).CData = ...
                    reshape(widget.glassbrain.UserData.CTvol(:,str2double(evt.NewValue.Children(sagittalIdx).Children(2).Children(2).Tag),:),[vol_size(1),vol_size(3)]);
                evt.NewValue.Children(sagittalIdx).Children(1).Text = ...
                    widget.tab_T1.Children(sagittalIdx).Children(1).Text;

                evt.NewValue.Children(axialIdx).Children(2).Children(1).Position = ...
                widget.tab_T1.Children(axialIdx).Children(2).Children(1).Position;
                evt.NewValue.Children(axialIdx).Children(2).Children(2).Tag = ...
                    widget.tab_T1.Children(axialIdx).Children(2).Children(2).Tag;
                evt.NewValue.Children(axialIdx).Children(2).Children(2).CData = ...
                    rot90(reshape(widget.glassbrain.UserData.CTvol(str2double(evt.NewValue.Children(axialIdx).Children(2).Children(2).Tag),:,:),[vol_size(2),vol_size(3)]));
        ...
        elseif isequal(currTab,'T1') && ~(isequal(evt.NewValue.Title,'[select Anatomical NIfTI file (optional)]'))
            ...
            if ~(isequal(widget.tab_CT.Title,'[select CT NIfTI file]'))
                ...
                evt.NewValue.Children(coronalIdx).Children(2).Children(1).Position = ...
                    widget.tab_CT.Children(coronalIdx).Children(2).Children(1).Position;
                evt.NewValue.Children(coronalIdx).Children(2).Children(2).Tag = ...
                    widget.tab_CT.Children(coronalIdx).Children(2).Children(2).Tag;
                evt.NewValue.Children(coronalIdx).Children(2).Children(2).CData = ...
                    widget.glassbrain.UserData.T1vol(:,:,str2double(evt.NewValue.Children(coronalIdx).Children(2).Children(2).Tag));
                evt.NewValue.Children(coronalIdx).Children(1).Text = ...
                ...
                evt.NewValue.Children(sagittalIdx).Children(2).Children(1).Position = ...
                    widget.tab_CT.Children(sagittalIdx).Children(2).Children(1).Position;
                evt.NewValue.Children(sagittalIdx).Children(2).Children(2).Tag = ...
                    widget.tab_CT.Children(sagittalIdx).Children(2).Children(2).Tag;
                evt.NewValue.Children(sagittalIdx).Children(2).Children(2).CData = ...
                    reshape(widget.glassbrain.UserData.T1vol(:,str2double(evt.NewValue.Children(sagittalIdx).Children(2).Children(2).Tag),:),[vol_size(1),vol_size(3)]);
                evt.NewValue.Children(sagittalIdx).Children(1).Text = ...
                    widget.tab_CT.Children(sagittalIdx).Children(1).Text;

                evt.NewValue.Children(axialIdx).Children(2).Children(1).Position = ...
                    widget.tab_CT.Children(axialIdx).Children(2).Children(1).Position;
                evt.NewValue.Children(axialIdx).Children(2).Children(2).Tag = ...
                    widget.tab_CT.Children(axialIdx).Children(2).Children(2).Tag;
                evt.NewValue.Children(axialIdx).Children(2).Children(2).CData = ...
                    rot90(reshape(widget.glassbrain.UserData.T1vol(str2double(evt.NewValue.Children(axialIdx).Children(2).Children(2).Tag),:,:),[vol_size(2),vol_size(3)]));
                evt.NewValue.Children(axialIdx).Children(1).Text = ...
