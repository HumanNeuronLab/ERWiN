function gitAutoUpdate
    ...
    if ~isempty(gitFetch) || isfile([scriptPath filesep '.updater'])
        ...
        quest = '\fontsize{10}A new version of ERWiN exists!';
            ...
            case 'Pull latest version'
                ...
                if contains(gitPull,['error: Your local changes to the '...
                    ...
                    quest = ['\fontsize{10}What would you like to do with ' ...
                        'modifications made in current version of ERWiN?'];
                    answer2 = questdlg(quest, ...
	                'ERWiN Update Conflict', ...
                    ...
                    switch answer2
                        ...
                        case 'Overwrite all files with new version'
                            opts.Interpreter = 'tex';
                            opts.Default = 'Cancel';
                            quest = '\fontsize{10}WARNING: You are about to overwrite current version of ERWiN!';
                            answer3 = questdlg(quest, ...
	                        'ERWiN Update Overwrite', ...
	                        'Yes, I confirm',...
                            'Cancel',opts);
                            switch answer3
                                case 'Yes, I confirm'
