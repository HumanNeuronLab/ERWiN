...
widget.button_rotateVol_CT = uibutton('Parent', widget.panel_sliceView4_CT,'Text','Rotate',...
    'Position',[widget.button_permuteVol_CT.Position(1),widget.button_selectNifti_CT.Position(2)-37,80,22],...
    'Enable','off','BackgroundColor',[0.5,0.5,0.5],'FontColor',[0.8,0.8,0.8]);
widget.label_voxelIntensity_CT = uilabel('Parent',widget.panel_sliceView4_CT,'Text','Voxel intensity:',...
    'Position',[widget.button_selectNifti_CT.Position(1),widget.button_rotateVol_CT.Position(2)-37,150,22],'Tag','Voxel Intensity');
