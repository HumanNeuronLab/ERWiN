...
widget.divider_centralPanel = uilabel('Parent',widget.panel_sliceView4_CT,'HorizontalAlignment','center',...
    'Text','____________________________________________________',...
    'Position',[0,75,widget.panel_sliceView4_CT.Position(3),20]);
widget.button_load = uibutton('Parent',widget.panel_sliceView4_CT,...
    'Text','Load ERWiN file','Position',[15 20 125 35],'Enable','off');
